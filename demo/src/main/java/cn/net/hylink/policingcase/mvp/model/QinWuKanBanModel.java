 ...
 */
@FragmentScope
public class QinWuKanBanModel extends BaseModel implements QinWuKanBanContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public QinWuKanBanModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<QwkbEntity>> getData(QwkbBean bean) {
        return mRepositoryManager.obtainRetrofitService(CommonService.class).getQwkbData(bean);
    }
}